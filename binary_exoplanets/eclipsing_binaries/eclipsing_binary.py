...
def eclipsing_binary():
    ...
    for n in range(ss.npts):
        ...
        ax.text(-1.5*a_star2, 1.1*a_star2, "star 1: T = %5.0f K" % (T1),
                color="C1", fontsize=10)
        ax.text(-1.5*a_star2, 0.95*a_star2, "star 2: T = %5.0f K" % (T2),
                color="C0", fontsize=10)
        ax.text(-1.5*a_star2, 0.8*a_star2,
        ...
        outfile = f"eclipsingbinary_{iframe:04d}.png"
        fig.savefig(outfile)
        plt.close(fig)
