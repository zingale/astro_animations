...
# make the movie
./binary_stars.py --mass1 1.0 --mass2 1.0 -e 0.0 -a 1.0
...
# make the movie
./binary_stars.py --mass1 2.0 --mass2 1.0 -e 0.0 -a 1.0
...
# make the movie
./binary_stars.py --mass1 1.0 --mass2 1.0 -e 0.4 -a 1.0
...
# make the movie
./binary_stars.py --mass1 2.0 --mass2 1.0 -e 0.4 -a 1.0
